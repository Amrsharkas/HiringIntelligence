          ...
          <CardContent className="space-y-6">
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Your subscription has been successfully activated and all premium features are now available.
              </p>
            </motion.div>
            ...
            >
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Need help? <a href="mailto:support@plato.com" className="text-blue-600 hover:text-blue-700">Contact Support</a>
              </p>
            </motion.div>
          </CardContent>
        </Card>
