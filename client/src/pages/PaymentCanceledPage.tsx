...
const PaymentCanceledPage: React.FC = () => {
  ...
  const handleTryAgain = () => {
    setLocation('/dashboard?tab=credits');
  };
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center pb-2">
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-2">
              Your credit purchase was canceled
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            >
              <p className="text-sm text-amber-800 dark:text-amber-200">
                ...
                You can try purchasing credits again whenever you're ready.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                <div className="flex items-start gap-2">
                  ...
                  <span>Try purchasing credits again</span>
                </div>
                <div className="flex items-start gap-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span>Choose a different credit package</span>
                </div>
              </div>
            </motion.div>
